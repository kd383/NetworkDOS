...
% complete the whole process of filtering the zero eigenvalues
%
% Q - filter applied (eigenvectors/null vectors)
% dname - data file e.g. 'Erdos02-cc'
% option - 'hash' uses edge-tracing and is much faster
%        - 'manual' traces through vertices
%        - 'hash-mod' DOES NOT WORK
%
% last updated: 12-22-2014 (comments)
